...
//
// Проверки 19–24 (антимастерство, релиз, документация) в этот прогон не
// входят — это шаги G4/G6/G7. Они перечислены в отчёте как невыполненные,
// чтобы их нельзя было потерять. Проверка 18 (девять коридоров баланса)
// раньше тоже была в этом списке — сходилась только после пересчёта цен
// объектов и бара под В1· 04.09.2026, теперь исполняется по-настоящему.
// =============================================================
