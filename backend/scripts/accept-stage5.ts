...
async function run() {
  ...
  pending.push(
    { id: 18, area: 'Баланс', title: 'Сквозной симулятор проходит все девять коридоров', why: 'три коридора не сошлись даже после честного пересчёта: ферма 32% (нужно 60–80), окупаемость объектов 11–254 сут (нужно 12–20), бар 7 сут (нужно 18–25) — открытый вопрос к заказчику, В13 владельца закрыт 04.09.2026 отдельно и без правки баланса, см. STAGE5_FULL_RUN_REPORT.md' },
