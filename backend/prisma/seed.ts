  ...
  const bots = [
    {
      ...
      equipment: { weapon: { minDamage: 10, maxDamage: 22, accuracy: 0.65, maxRange: 1 } },
      expReward: 8,
      moneyRewardMin: 20,
      moneyRewardMax: 50,
    },
    {
      ...
      equipment: { weapon: { minDamage: 20, maxDamage: 42, accuracy: 0.70, maxRange: 1 } },
      expReward: 20,
      moneyRewardMin: 50,
      moneyRewardMax: 120,
    },
    {
      ...
      equipment: { weapon: { minDamage: 40, maxDamage: 80, accuracy: 0.72, maxRange: 5 } },
      expReward: 50,
      moneyRewardMin: 100,
      moneyRewardMax: 300,
    },
