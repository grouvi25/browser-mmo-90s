export enum ErrorCode {
  ...
  // Этап 5: админка с обратимостью.
  ADMIN_FORBIDDEN         = 'ADMIN_001',
  ADMIN_ACTION_NOT_FOUND  = 'ADMIN_002',
  ADMIN_ALREADY_ROLLED_BACK = 'ADMIN_003',
  ADMIN_STATE_CHANGED     = 'ADMIN_004',
  ADMIN_REASON_TOO_SHORT  = 'ADMIN_005',
  ADMIN_TRACE_NOT_FOUND   = 'ADMIN_006',
  ADMIN_TERRITORY_IN_BATTLE = 'ADMIN_007',
  ADMIN_BATTLE_STATE      = 'ADMIN_008',
  MARKET_PAIR_LIMIT       = 'MARKET_011',
  PREM_GRANT_NOT_READY    = 'PREM_003',
