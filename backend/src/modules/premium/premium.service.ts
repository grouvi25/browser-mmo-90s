 ...
 * целью. Решением заказчика от 03.09.2026 (вопрос В8 Этапа 5) все семь
 * отложены за первую версию: платёжного шлюза в ней всё равно нет, продавать
 * их нечем.
 *
 * Товар нельзя ни продать, ни выдать: покупка, которая ничего не делает и
 * при этом записывается в историю, хуже отсутствующего товара. Список самих
 * товаров живёт в PREMIUM_PRODUCTS_DEFERRED — он же задача следующей версии.
 */
