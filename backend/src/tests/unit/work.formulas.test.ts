...
import { calcFinalSalary, calcProductionExp, getProductionLevelFromExp, objectLevelCoeff, workerEfficiency } from '../../modules/work/work.formulas'
describe('work formulas',()=>{
 ...
 it('calculates deterministic salary and clamps to x3',()=>{expect(calcFinalSalary(100,1,0,0.5)).toBe(100);expect(calcFinalSalary(100,99,10,1)).toBe(300)})
