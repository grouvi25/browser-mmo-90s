...
test.describe('Stage 2 visual and browser flow', () => {
  ...
  test('E5 upgrades shows preview controls for buyer item', async ({ page }, testInfo) => {
    ...
    // Шанс стоит строкой состояния под панелью, где в макете идут три
    // строки о состоянии сумки. Проверка прежняя: список вещей, выбор
    // усиления, живой расчёт и кнопка.
