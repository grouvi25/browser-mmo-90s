      ...
      <div className="row" style={{ gap: 8 }}>
        ...
        <div className="panel" style={{ flex: '0 0 240px', borderColor: 'var(--green-dim)' }}>
          ...
          <div className="panel-body" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={{ fontSize: 13.65, color: 'var(--text-dim)' }}>
            ...
            <div style={{ fontSize: 13.49, color: 'var(--text-dim)', fontStyle: 'italic' }}>
                  ...
                  {openDuels.map((duel: OpenDuel) => (
                    <tr key={duel.battleId} style={{ opacity: duel.canJoin ? 1 : 0.5 }}>
                      <td>
                        ...
                        <div style={{ fontSize: 13.49, color: 'var(--text-dim)' }}>
                      ...
                      <td style={{ fontSize: 13.65, color: 'var(--text-dim)' }}>
                      ...
                      <td>
                        {duel.canJoin ? (
                          ...
                          <span style={{ fontSize: 13.49, color: 'var(--text-dim)' }}>
