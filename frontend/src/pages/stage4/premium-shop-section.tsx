...
export function PremiumShopSection() {
  ...
  return (
    <>
      ...
      <p className="s4-note-box">
        В витрине только то, что уже работает. Косметика, места в инвентаре,
        ускорение цикла и полив грядки задуманы, но пока не сделаны, и
        показывать их как товар было бы обманом.
      </p>
