...
export const MENU = {
  ...
  /** Наличные персонажа в шапке. Полоса меню между «радио» (правый край 1096)
      и «выходом» (левый край 1471,5) в макете пуста — сумма встаёт туда и
      прижимается вправо, чтобы расти влево и не подъезжать под «выход». */
  navMoney: box(1146, 5.5, 290, 26),
  navFontSize: 21.9,
  navDy: -2,
